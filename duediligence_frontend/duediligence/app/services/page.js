...
const services = [
  {
    ...
    description:
      "Access your academic journey in one place. View schedules, track attendance, and stay on top of deadlines.",
  ...
  },
  {
    title: "Teacher Suite",
    description:
      "Streamline classroom management. Create exams, input scores, view number of students in a class, and generate student performance reports instantly.",
    icon: <ClipboardList className="w-10 h-10 text-pink-500" />,
    features: [
      "Exam Creation",
      "Bulk Score Entry",
      "Parent Communication",
      "Student/Class Capacity",
    ],
  },
  {
    title: "Admin Control",
    description:
      "Full oversight of the institution. Manage registrations, audit records, and maintain system security.",
  ...
  },
  {
    ...
    description:
      "Robust testing environment with automated grading and instant feedback loops for students.",
  ...
  },
  {
    ...
    description:
      "Visualize progress with detailed charts. Identify learning gaps and celebrate academic growth.",
  ...
  },
  {
    ...
    description:
      "Encrypted storage for all academic transcripts and personal data, ensuring 100% compliance.",
