...
<div className = " mb-5 h-auto">
    ...
    <p className = "text-medium ">Don't Have an Account?</p>
                <a href="/register" className="relative pb-1 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-slate-900 after:transition-all after:duration-300 after:delay-300 hover:after:w-full">
            Sign Up
          </a>
          </div>
