      ...
      <div className="relative z-10 backdrop-blur-sm flex min-h-screen items-center justify-center  px-4">
        <div className="w-full max-w-xl rounded-2xl bg-zinc-100 p-8 shadow-lg  my-4">
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <a
              href="/login"
              className="font-medium text-slate-900 relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-slate-600 after:duration-300 after:transition-all after:delay-300 hover:after:w-full"
            >
              Log in
            </a>
          </p>
